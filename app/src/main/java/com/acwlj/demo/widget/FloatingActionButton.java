...
public class FloatingActionButton extends View{
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CircularFloatingActionButton);

        mCirclePaint.setColor(array.getColor(R.styleable.CircularFloatingActionButton_circularactionColor, Color.WHITE));
        mActionIcon = array.getDrawable(R.styleable.CircularFloatingActionButton_circularactionIcon);
        ...
        CircularViewUtils.setBackground(this, r.getDrawable(R.drawable.floatingactionbutton_shadow_layer));
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if(mActionIcon != null){
            mActionIcon.setVisible(CircularViewUtils.isVisible(this), false);
        }
    }
