...
import com.acwlj.demo.widget.CircularViewUtils;
import com.nooeyes.github.circular.widget.RevealFrameLayout;
/**
...
public class CircularRevealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                CircularViewUtils.removeGlobalListeners(mToolbar, this);
    ...
    public static class RecycleAdapter  extends RecyclerView.Adapter<CardHolder>{
        ...
        public CardHolder onCreateViewHolder(ViewGroup group, int i) {
            ...
            return new CardHolder(factory.inflate(R.layout.circular_card_item, group, false));
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.circular_main_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.sample2:
                intent = new Intent(this, CircularSample2Activity.class);
                break;

            case R.id.sample3:
                intent = new Intent(this, CircularSample3Activity.class);
                break;
            ...
            case R
                ...
                getSupportFragmentManager()
                        .beginTransaction()
                        .add(android.R.id.content, new CircularRevealExampleFragment(), "fragment:reveal")
