package com.nooeyes.github.circular.animation;
...
import com.nooeyes.github.circular.animation.RevealAnimator.RevealInfo;

import static android.os.Build.VERSION.SDK_INT;
import static android.os.Build.VERSION_CODES.LOLLIPOP;
import static com.nooeyes.github.circular.animation.RevealAnimator.CLIP_RADIUS;
...
public class ViewAnimationUtils {
    ...
    public static com.nooeyes.github.circular.animation.SupportAnimator createCircularReveal(View view,
    ...
    public static com.nooeyes.github.circular.animation.SupportAnimator createCircularReveal(View view,
        ...
        if(!(view.getParent() instanceof com.nooeyes.github.circular.animation.RevealAnimator)){
            throw new IllegalArgumentException("View must be inside RevealFrameLayout or RevealLinearLayout.");
        }

        com.nooeyes.github.circular.animation.RevealAnimator revealLayout = (com.nooeyes.github.circular.animation.RevealAnimator) view.getParent();
