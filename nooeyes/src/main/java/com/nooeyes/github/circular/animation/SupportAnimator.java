...
public abstract class SupportAnimator extends Animator{
    ...
    public SupportAnimator(com.nooeyes.github.circular.animation.RevealAnimator target) {
    ...
    public SupportAnimator reverse() {
        ...
        com.nooeyes.github.circular.animation.RevealAnimator target = mTarget.get();
        if(target != null){
